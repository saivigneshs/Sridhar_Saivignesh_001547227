...
public class FacultyProfile {
    ...
    public FacultyProfile(Person p, int publicatons) {
    ...
    public double calcFacultyRating(){
        double avgRating = 0.0;
        int count = 0;
        for(FacultyAssignment fa : facultyassignments){
        avgRating += fa.courseoffer.getFacRating();
        count++;
        }
        avgRating = avgRating/count;
        
        System.out.println("avgRating "+avgRating+" given to Faculty : "+person.getPersonId());
    return avgRating;
    }
}
