...
import Business.Role.SecurityERAdmin;
...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 520, -1, -1));
        ...
        jLabel6.setText("ENTERPRISE ADMIN DETAILS");
    ...
    private void btnSubmitMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubmitMousePressed
        ...
        if (null != enterprise.getEnterpriseType()) {
            switch (enterprise.getEnterpriseType()) {
                case GeoInfra:
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new GeoInfraAdmin());
                    break;
                case Entertainment:
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new EntertainmentAdmin());
                    break;
                case Catering:
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new CateringAdmin());
                    break;
                case SecurityER:
