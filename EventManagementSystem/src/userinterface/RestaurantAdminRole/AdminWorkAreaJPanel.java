...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private final Business.Order.Menu menuDirectory;
    private final OrderDirectory orderDirectory;
    private final UserAccount account;
    private final DeliverManDirectory deliveryManDirectory;
    
    /** Creates new form AdminWorkAreaJPanel */
   public AdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem system, RestaurantDirectory restaurantDirectory, DeliverManDirectory deliveryManDirectory, Business.Order.Menu menuDirectory, OrderDirectory orderDirectory) {
        initComponents();
